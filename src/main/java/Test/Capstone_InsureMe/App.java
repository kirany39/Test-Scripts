package Test.Capstone_InsureMe;
...
public class App 
{
  public static void main( String[] args ) throws InterruptedException, IOException
  {
	    ...
	    driver.findElement(By.id("inputName")).sendKeys("Kiran Prasad");
	    Thread.sleep(2000);
	  
	    driver.findElement(By.id("inputNumber")).sendKeys("9187594752");
	    Thread.sleep(2000);
	   
	    driver.findElement(By.id("inputMail")).sendKeys("kiran@xyz.com");
        ...
        File destFile = new File("C:\\Users\\HP\\Desktop\\Insure\\test-reports.jpg");
